...
namespace ElectroCorp.Platform.Shared.Infrastructure.Pipeline.Middleware.Components;
    ...
    IStringLocalizer<CommonMessages> commonLocalizer)
{
    ...
    private async Task HandleOperationCanceledExceptionAsync(HttpContext context, OperationCanceledException exception)
    {
        ...
        var problemDetails = new ProblemDetails
        {
            ...
            Title = errorLocalizer["OperationCancelled"].Value,
            Detail = errorLocalizer["OperationCancelled"].Value,
    ...
    private async Task HandleGenericExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var problemDetails = new ProblemDetails
        {
            ...
            Title = commonLocalizer["InternalServerError"].Value,
            Detail = errorLocalizer["GenericError"].Value,
            Instance = context.Request.Path
        };
